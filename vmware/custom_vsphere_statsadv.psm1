...
# @clintonskitson
#
# custom_vsphere_statsadv.psm1 - A reproduction of PowerCLI Get-Stat functionality using vSphere SDK SOAP methods
#
##
...
function Connect-VIServerVIM {
    ...
    [void]$global:vimClient.Connect("https://$viserver/sdk")
...
[CmdletBinding()]
    ...
    End {
        ...
        $global:vimClient.VimService.QueryPerf($vimServiceContent.perfManager,$pgsList) | where {$_.sampleInfo} | %{
            $retrievedStat = $_
