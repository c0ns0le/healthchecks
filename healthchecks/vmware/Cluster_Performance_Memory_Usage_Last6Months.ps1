...
#			./get-Performance-Clusters.ps1 -srvconnection $srvconnection -logdir C:\admin\sas;ldkajsd
#
#/*
...
param([object]$srvConnection="",
	...
	[Object[]]$mymetrics = @("cpu.usage.average","clusterServices.effectivecpu.average","mem.usage.average","clusterServices.effectivemem.average")
	)
#[Object[]]$mymetrics = "cpu.usagemhz.average","cpu.usage.average","mem.usage.average","mem.totalmb.average","mem.consumed.average","mem.swapused.average","mem.vmmemctl.average","clusterServices.effectivemem.average")
...
if ($showByMonth)
{
    ...
    $clusters | %{
		...
		$metaInfo = @()
		$metaInfo +="tableHeader=Virtual Machines Grouped by VMware Tools"
		$metaInfo +="introduction=This report exports a list Virtual Machines with tools missing or out-of-date. with vmWare Tools issues"
		...
		$metainfo +="chartType=line"
		$metainfo +="chartText=Monthly Usage (Last 6 months)"
